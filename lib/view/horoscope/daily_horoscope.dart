...
class _DailyHoroscopeState extends State<DailyHoroscope> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppbarProfile(userName: "Daily Horoscope"),
      body: SafeArea(
            ...
            child: Column(
              children: [
                ...
                DropdownButtonFormField<String>(
                  value: _selectGender, // The currently selected value
                  onChanged: (newValue) {
                    setState(() {
                      ...
                      await AstroApiServices()
                          ...
                          .then((value) {
                            GoRouter.of(context).pushNamed(
                              RoutesName.dailyHoroscopeDetailsRoute,
                              extra: {
                                "inputData": {
                                  "day": int.parse(dob[0]),
                                  "month": int.parse(dob[1]),
                          ...
                          .catchError((e) {
                            var snackBar = SnackBar(
                              backgroundColor: Colors.white,
                              content: Text(
                                'Failed to fetch Daily Horoscope data',
